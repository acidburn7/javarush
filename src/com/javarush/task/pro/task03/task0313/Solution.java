...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        if (string2 == string3) System.out.println(same); else System.out.println(different);
        if (string1 == string3) System.out.println(same); else System.out.println(different);
